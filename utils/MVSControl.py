...
class MVSController:
    ...
    def get_image(self, debug=False):
        ...
        # print("Image Info: Width[%d], Height[%d], PixelFormat[%s]" % (width, height, pixel_format))
        # height = 3072
        # width = 2048
        # pixel_format = PixelType_Gvsp_BGR8_Packed   # 强制指定格式#################
...
if __name__ == "__main__":
    ...
    cv2.namedWindow("image", cv2.WINDOW_NORMAL)
    image = mvs_control.get_image(debug=True)
