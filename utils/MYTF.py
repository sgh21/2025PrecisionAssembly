...
if __name__ == "__main__":
    ...
    T= tf_tree.get_transform('child2', 'world')
    point_in_world = T @ [1, 0, 0, 1]
    print("Point in child2 transformed to world:", point_in_world[:3])
    
    point_in_world = tf_tree.transform_pose([1, 0, 0],[0,0,0,1], 'child2', 'world',)
